...
// Generated 19-Feb-2022 16:54:11
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"Simulation\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(Simulation_M, (NULL));
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(Simulation_M)
                == (NULL)));
    ...
    {
      mRunModel = (rtmGetErrorStatus(Simulation_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
